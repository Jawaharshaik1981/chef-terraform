...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/opt/chefdk/embedded")
  ...
  CONFIG["configure_args"] = " '--prefix=/opt/chefdk/embedded' '--without-ext=dbm,readline' '--enable-shared' '--disable-install-doc' '--without-gmp' '--without-gdbm' '--without-tk' '--disable-dtrace' '--with-bundled-md5' '--disable-jit-support' '--with-opt-dir=/opt/chefdk/embedded' 'CFLAGS=-I/opt/chefdk/embedded/include -O2 -O3 -g -pipe' 'LDFLAGS=-Wl,-rpath,/opt/chefdk/embedded/lib -L/opt/chefdk/embedded/lib' 'CPPFLAGS=-I/opt/chefdk/embedded/include -O2 -O3 -g -pipe' 'CXXFLAGS=-I/opt/chefdk/embedded/include -O2 -O3 -g -pipe'"
  ...
  CONFIG["RUBY_EXEC_PREFIX"] = "/opt/chefdk/embedded"
  ...
  CONFIG["COMMON_LIBS"] = ""
  CONFIG["MAINLIBS"] = "-lz -lpthread -lrt -lrt -ldl -lcrypt -lm "
  ...
  CONFIG["STATIC"] = ""
  CONFIG["ARCH_FLAG"] = ""
  CONFIG["DLDFLAGS"] = "-Wl,-rpath,/opt/chefdk/embedded/lib -L/opt/chefdk/embedded/lib -Wl,--compress-debug-sections=zlib -L/opt/chefdk/embedded/lib  -Wl,-rpath,/opt/chefdk/embedded/lib"
  CONFIG["ALLOCA"] = ""
  CONFIG["MATHN"] = "yes"
  CONFIG["dsymutil"] = ""
  CONFIG["codesign"] = ""
  ...
  CONFIG["try_header"] = ""
  CONFIG["CC_VERSION_MESSAGE"] = "gcc (GCC) 4.8.5 20150623 (Red Hat 4.8.5-36)\nCopyright (C) 2015 Free Software Foundation, Inc.\nThis is free software; see the source for copying conditions.  There is NO\nwarranty; not even for MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE."
  ...
  CONFIG["CPP"] = "$(CC) -E"
  CONFIG["CXXFLAGS"] = "-I/opt/chefdk/embedded/include -O2 -O3 -g -pipe"
  CONFIG["CXX"] = "g++"
  CONFIG["OBJEXT"] = "o"
  CONFIG["CPPFLAGS"] = "-I/opt/chefdk/embedded/include -O2 -O3 -g -pipe -I/opt/chefdk/embedded/include $(DEFS) $(cppflags)"
  CONFIG["LDFLAGS"] = "-L. -Wl,-rpath,/opt/chefdk/embedded/lib -L/opt/chefdk/embedded/lib -fstack-protector-strong -rdynamic -Wl,-export-dynamic -L/opt/chefdk/embedded/lib  -Wl,-rpath,/opt/chefdk/embedded/lib"
  CONFIG["CFLAGS"] = "-I/opt/chefdk/embedded/include -O2 -O3 -g -pipe -fPIC"
  CONFIG["CC"] = "gcc"

# -*- encoding: utf-8 -*-
# stub: train-aws 0.1.11 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.date = "2019-08-15"
  s.description = "Allows applictaions using Train to speak to AWS; handles authentication, cacheing, and SDK dependency management.".freeze

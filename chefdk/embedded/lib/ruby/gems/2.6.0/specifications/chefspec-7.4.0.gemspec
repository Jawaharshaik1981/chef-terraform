...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<chef>.freeze, [">= 13"])
      s.add_runtime_dependency(%q<fauxhai>.freeze, [">= 6.11"])
      s.add_runtime_dependency(%q<rspec>.freeze, ["~> 3.0"])
    else
      s.add_dependency(%q<chef>.freeze, [">= 13"])
      s.add_dependency(%q<fauxhai>.freeze, [">= 6.11"])

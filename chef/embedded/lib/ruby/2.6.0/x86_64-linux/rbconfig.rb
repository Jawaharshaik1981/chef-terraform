...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/opt/chef/embedded")
  ...
  CONFIG["configure_args"] = " '--prefix=/opt/chef/embedded' '--without-ext=dbm,readline' '--enable-shared' '--disable-install-doc' '--without-gmp' '--without-gdbm' '--without-tk' '--disable-dtrace' '--with-bundled-md5' '--disable-jit-support' '--with-opt-dir=/opt/chef/embedded' 'CFLAGS=-I/opt/chef/embedded/include -O2 -O3 -g -pipe' 'LDFLAGS=-Wl,-rpath,/opt/chef/embedded/lib -L/opt/chef/embedded/lib' 'CPPFLAGS=-I/opt/chef/embedded/include -O2 -O3 -g -pipe' 'CXXFLAGS=-I/opt/chef/embedded/include -O2 -O3 -g -pipe'"
  ...
  CONFIG["RUBY_EXEC_PREFIX"] = "/opt/chef/embedded"
  ...
  CONFIG["STATIC"] = ""
  CONFIG["ARCH_FLAG"] = ""
  CONFIG["DLDFLAGS"] = "-Wl,-rpath,/opt/chef/embedded/lib -L/opt/chef/embedded/lib -Wl,--compress-debug-sections=zlib -L/opt/chef/embedded/lib  -Wl,-rpath,/opt/chef/embedded/lib"
  CONFIG["ALLOCA"] = ""
  CONFIG["MATHN"] = "yes"
  CONFIG["dsymutil"] = ""
  CONFIG["codesign"] = ""
  ...
  CONFIG["CPP"] = "$(CC) -E"
  CONFIG["CXXFLAGS"] = "-I/opt/chef/embedded/include -O2 -O3 -g -pipe"
  CONFIG["CXX"] = "g++"
  CONFIG["OBJEXT"] = "o"
  CONFIG["CPPFLAGS"] = "-I/opt/chef/embedded/include -O2 -O3 -g -pipe -I/opt/chef/embedded/include $(DEFS) $(cppflags)"
  CONFIG["LDFLAGS"] = "-L. -Wl,-rpath,/opt/chef/embedded/lib -L/opt/chef/embedded/lib -fstack-protector-strong -rdynamic -Wl,-export-dynamic -L/opt/chef/embedded/lib  -Wl,-rpath,/opt/chef/embedded/lib"
  CONFIG["CFLAGS"] = "-I/opt/chef/embedded/include -O2 -O3 -g -pipe -fPIC"
  CONFIG["CC"] = "gcc"
